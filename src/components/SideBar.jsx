...
export const SideBarItem = ({ icon, text, active, alert }) => {
  ...
  return (
    ...
    >
      ...
      {!expanded && (
        <div
          className={`absolute left-full rounded-md px-2 py-1 ml-6 bg-indigo-100 text-indigo-800 text-sm invisible opacity-20 -translate-x-3 transition-all group-hover:opacity-100 group-hover:translate-x-0`}
        >
          {text}
        </div>
      )}
